          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_group.php?id=<?php echo (int)$a_group['id'];?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">

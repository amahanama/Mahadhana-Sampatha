...
<script type="text/javascript">
	...
	function validateInputs(){
		if(document.getElementById('auto_generated_pin').value.length == 0){
			alert("Please enter Computer Generated Random Number");	
	...
	function initiateDraw(){
		...
		var avg_pin_1=Math.round(document.getElementById('pin_1').value/100000);
		var avg_pin_2=Math.round(document.getElementById('pin_2').value/100000);
		var avg_pin_3=Math.round(document.getElementById('pin_3').value/100000);
		var avg_pin_4=Math.round(document.getElementById('pin_4').value/100000);
		var avg_pin_5=Math.round(document.getElementById('pin_5').value/100000);	
		var avg_auto_generated_pin=Math.round(document.getElementById('auto_generated_pin').value/100000);			
		...
		let avg=computeAverageOfNumbers(avg_arr);//Calc_totals(units)	

			
		//let avg=Calc_totals(avg_arr);
	...
	function calculateSumArr(array) {
        ...
        <div class="col-md-6" id="winner_report" name="winner_report">
			...
			<div class="form-group">
              <label for="email">Pin Number 04</label>
                 <input type="text" required class="form-control" name="pin_4" id="pin_4" placeholder="Pin Number 04" type="text" onkeypress="return /[0-9]/i.test(event.key)" maxlength="20">
            </div>
			<div class="form-group">
            ...
            <div class="form-group clearfix">
              <button type="button" name="add"  class="btn btn-primary" style="width:100px;" onclick="initiateDraw()">Initiate Draw</button>
				<button type="button" name="cancel" class="btn btn-primary" style="width:100px;" onclick="location.reload();">Cancel</button>
            </div>

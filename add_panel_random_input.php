<?php
  $page_title = 'Add Panel Random Input';
		...
		<div class="col-md-12">	
			...
			<table class="table table-bordered" style="padding-top:10px;" id="data_list" name="data_list">
				...
				<tr>				
					...
					<td style="text-align:left;width=10%"><button><a href="test.php?varname=<?php echo remove_junk(ucwords($p1['id'])) ?>">+</a></button></td>
				</tr>
				...
				<tr>				
					...
					<td style="text-align:left;width=10%"><button><a href="test.php?varname=<?php echo remove_junk(ucwords($p2['id'])) ?>">+</button></a></td>
				</tr>
				...
				<tr>				
					...
					<td style="text-align:left;width=10%"><button><a href="test.php?varname=<?php echo remove_junk(ucwords($p3['id'])) ?>">+</a></button></td>
				</tr>
				...
				<tr>				
					...
					<td style="text-align:left;width=10%"><button><a href="test.php?varname=<?php echo remove_junk(ucwords($p4['id'])) ?>">+</a></button></td>
				</tr>
				...
				<tr>				
					...
					<td style="text-align:left;width=10%"><button><a href="test.php?varname=<?php echo remove_junk(ucwords($p5['id'])) ?>">+</a></button></td>
				</tr>
			</table>
			</div>
			...
			<div class="col-md-4">
						<br>
						<button type="submit" name="submit" id="submit" class="btn btn-primary" style="width:100px;" >Update Allocation</button>

<?php
  ...
  //$all_groups = find_all('draw_allocation');
  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="assign_draw.php" class="btn btn-info pull-right btn-sm"> Draw Panel Allocation</a>
    </div>
      ...
      <table class="table table-bordered">
        ...
        <?php foreach($all_groups as $a_group): ?>
          <tr>
		   ...
		   <td><?php echo remove_junk(ucwords($a_group['operator']))?></td>
           <td class="text-center">
          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                <a href="edit_draw_allocation.php?id=<?php echo (int)$a_group['id'];?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
